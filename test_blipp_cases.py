...
class TestLunchpad(unittest.TestCase):
    ...
    def test_correct_text(self):
        ...
        actual = handle_input("***REMOVED***", tags, times, datetime.datetime(2020, 11, 11, 12, 10, 10),[],"test_data.csv")
        expected = True, "GODKÄND SKANNING! SMAKLIG MÅLTID!"
        self.assertEqual(expected, actual)

        # Scanned tag is first in list
        actual = handle_input("***REMOVED***", tags, times, datetime.datetime(2020, 11, 11, 12, 10, 10),["c3f4286f131e08c4b8d1570bee6a4a44250834d3c44aecae7c10ed9e1e7a98c5", "2711ec7bebeff204b1d6d39cc8dcbfbef44d93da919befb9834a839d98a5e1bf"],"test_data.csv")
        expected = False, "DU HAR REDAN SKANNAT"
        self.assertEqual(expected, actual)

        # Scanned tag is last in list
        actual = handle_input("***REMOVED***", tags, times, datetime.datetime(2020, 11, 11, 12, 10, 10),["2711ec7bebeff204b1d6d39cc8dcbfbef44d93da919befb9834a839d98a5e1bf", "c3f4286f131e08c4b8d1570bee6a4a44250834d3c44aecae7c10ed9e1e7a98c5"],"test_data.csv")
        expected = False, "DU HAR REDAN SKANNAT"
        self.assertEqual(expected, actual)

        # Scanned tag is in the middle of the list
        actual = handle_input("***REMOVED***", tags, times, datetime.datetime(2020, 11, 11, 12, 10, 10),["2711ec7bebeff204b1d6d39cc8dcbfbef44d93da919befb9834a839d98a5e1bf", "c3f4286f131e08c4b8d1570bee6a4a44250834d3c44aecae7c10ed9e1e7a98c5", "1514aa8277131f9dc6c69f615fae6e15cce2022237a5c98a3533f2007bb99aba"],"test_data.csv")
        expected = False, "DU HAR REDAN SKANNAT"
        self.assertEqual(expected, actual)
        ...
        actual = handle_input("***REMOVED***", tags, times, datetime.datetime(2020, 11, 14, 12, 10, 10),[],"test_data.csv")
